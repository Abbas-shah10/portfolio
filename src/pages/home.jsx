...
const Home = () => {
  ...
  const techStackIcons = [
    ...
    // {
    //   src: "https://cdn.prod.website-files.com/6047a9e35e5dc54ac86ddd90/63018721094449d9901f5875_cff297d7.png",
    //   alt: "Firebase",
    // },
    // {
    //   src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRvCzIa9WkTmFYqEthuD7jFKuEYSnJA2yG3dQ&s",
    //   alt: "Render",
    // },
    {
  ...
  return (
    <div
      className="min-h-screen z-10 font-sans"
    ...
    "
      ...
      "
        ...
        <div className="flex flex-col sm:flex-row sm:space-x-6 space-y-4 sm:space-y-0 mb-16">
          ...
          >
            <span
              className="w-3 h-3 rounded-full glow-dot mr-2"
        ...
        <section className="mt-20 max-w-4xl text-left px-4">
          ...
          >
            ...
            who loves turning ideas into clean, scalable web experiences.
          </p>
          <p
            className="text-base sm:text-lg mb-4 leading-relaxed"
            style={{ color: "var(--link-text)" }}
          >
            I actively explore emerging web technologies and best practices to
            enhance performance, security, and maintainability. My projects
            showcase not only my technical skills but also my ability to
            collaborate, adapt to new challenges, and deliver high-quality
            products. I’m passionate about contributing to meaningful projects
            and growing as a developer while making a tangible impact in the
            digital space.
          </p>
          <p className="text-base sm:text-lg mb-4 leading-relaxed">
            Connect with me on{" "}
            <a
              href="https://www.linkedin.com/in/muhammad-abbas-khan-58a7673b4/"
              target="_blank"
            ...
            and{" "}
            <a
              href="https://www.instagram.com/abbas_khanshah/"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:underline font-medium"
              style={{ color: "#E4405F" }}
